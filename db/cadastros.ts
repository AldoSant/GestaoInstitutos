  ...
  const [registros, listaDependentes] = await Promise.all([
    db
      .select({
        pessoa: {
          ...
          rgUf: pessoas.rgUf,
          rgEmissao: pessoas.rgEmissao,
          estadoCivil: pessoas.estadoCivil,
          naturalidade: pessoas.naturalidade,
          inscricaoInss: pessoas.inscricaoInss,
          conselhoTipo: pessoas.conselhoTipo,
          conselhoNumero: pessoas.conselhoNumero,
          aposentado: pessoas.aposentado,
          cnh: pessoas.cnh,
          cnhCategoria: pessoas.cnhCategoria,
          cnhValidade: pessoas.cnhValidade,
          nomeFantasia: pessoas.nomeFantasia,
          representanteLegal: pessoas.representanteLegal,
          inscricaoMunicipal: pessoas.inscricaoMunicipal,
          inscricaoEstadual: pessoas.inscricaoEstadual,
          email: pessoas.email,
          telefone: pessoas.telefone,
          celular: pessoas.celular,
          celularAlternativo: pessoas.celularAlternativo,
          papelPrestador: pessoas.papelPrestador,
        ...
        endereco: {
          ...
          referencia: pessoasEnderecos.referencia,
        },
        conta: {
    ...
    db
      .select({
        ...
        baixaSalarioFamilia: dependentes.baixaSalarioFamilia,
        baixaIrrf: dependentes.baixaIrrf,
